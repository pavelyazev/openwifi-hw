...
# 
# openwifi.tcl: Tcl script for re-creating project
#
# Generated by Vivado on Mon Jan 09 12:03:42 CET 2023
...
set _xil_proj_name_ "openwifi_libresdr"
...
# [file normalize "${origin_dir}/src/ad5640_spi.v" ]\
# [file normalize "${origin_dir}/src/ppsloop.v" ]\
...
#set file "${origin_dir}/src/ppsloop.v"
#set file [file normalize $file]
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "file_type" -value "Verilog" -objects $file_obj
#set_property -name "is_enabled" -value "1" -objects $file_obj
...
#set file "${origin_dir}/src/ad5640_spi.v"
#set file [file normalize $file]
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "file_type" -value "Verilog" -objects $file_obj
#set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/openwifi_e310v2.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/openwifi_e310v2.srcs/utils_1/imports/impl_1" -objects $obj
